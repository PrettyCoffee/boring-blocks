  ...
  <Primitive.Trigger
    render={
      <Button
        className={cn(
          maxWidth,
          "justify-between gap-2 truncate border border-stroke-muted in-[table_tr:not(:hover),[role='grid']_[role='row']:not(:hover)]:border-transparent data-placeholder:text-text-muted",
